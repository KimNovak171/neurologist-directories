...
export const metadata: Metadata = {
  title: "Contact Us | Neurologist Directories",
  description:
    "Get in touch with NeurologistDirectories.com. Send a message or email hello@directoriesnetwork.com for questions about our directory or featured listings.",
  alternates: {
    canonical: "/contact",
    languages: {
      "en-us": "https://neurologistdirectories.com/contact",
    },
  },
  openGraph: {
    title: "Contact Us | Neurologist Directories",
    description:
      "Contact NeurologistDirectories.com for questions about our directory or featured listings.",
    url: "/contact",
...
export default function ContactPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "NeurologistDirectories.com", item: `${siteUrl}/` },
