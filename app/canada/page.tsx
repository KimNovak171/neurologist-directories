...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = `Neurologists in Canada | ${total} verified listings | Neurologist Directories`;
  const description = `Browse ${total} verified neurologists and neurology practices across ${provinces} provinces and territories—maps, contact info, and Google ratings. Every listing rated 3 stars or higher on Google Maps.`;
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Canada neurologist directory preview",
        },
      ],
    },
  };
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
          <div className="space-y-6 text-foreground">
            ...
            <h1 className="text-balance text-3xl font-semibold leading-tight sm:text-4xl lg:text-5xl">
              Neurologists in Canada — Province by Province
            </h1>
            <p className="max-w-2xl text-balance text-sm sm:text-base text-foreground/80">
              Verified neurologists and neurology practices across provinces and territories.
          ...
          <div className="w-full rounded-2xl border-2 border-teal/40 bg-surface p-6 shadow-xl shadow-navy/20 ring-1 ring-teal/30">
            ...
            <p className="mt-2 text-sm text-foreground/90">
              Browse verified neurologists by province, then drill down
